...
namespace Esfa.Poc.Matching.FileReader.Csv.IntegrationTests.Contacts
{
    [Trait("Contacts Csv", "Successfully loaded file")]
    public class CsvLoadedSuccess
    {
        private readonly ContactLoadResult _loadResult;

        private const string DataFilePath = "./Contacts/Contact-Simple.csv";
        ...
        public void ModifiedIsCorrectForRecord1() =>
            Assert.Equal(new DateTime(2018, 3, 12, 16, 50, 0), _firstRecord.Modified);
        ...
        public void CreatedIsCorrectForRecord1() =>
            Assert.Equal(new DateTime(2016, 11, 29, 10, 54, 0), _firstRecord.Created);
        #endregion
    }
}