...
namespace Esfa.Poc.Matching.FileReader.Excel.IntegrationTests.Employers
{
    [Trait("Employers Excel", "Successfully loaded file")]
    public class ExcelLoadedSuccess
    {
        private readonly EmployerLoadResult _loadResult;

        private const string DataFilePath = "./Employers/Employer-Simple.xlsx";
        private readonly FileUploadEmployer _firstRecord;
