...
namespace Esfa.Poc.Matching.FileReader.Csv.IntegrationTests.Queries
{
    [Trait("Queries Csv", "Successfully loaded file")]
    public class CsvLoadedSuccess
    {
        private readonly QueryLoadResult _loadResult;

        private const string DataFilePath = "./Queries/Query-Simple.csv";
